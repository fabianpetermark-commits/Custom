...
- Bal oldalon látod mind a 10 pályát (a Worlds/Levels listában).
- Az entitás-paletta jobb oldalon: `Platform`, `Spike`, `Saw`, `Pendulum`, `MosquitoSwarm`, `Leech`, `Ladder`, `Wall`, `Slope`, `Rope`, `Water`, `FishSpawner`, `Start`, `Goal`.
